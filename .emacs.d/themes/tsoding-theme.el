...
(custom-theme-set-faces
 ...
 '(diff-removed ((t (:foreground "#ff4f58" :background unspecified))))
 '(diff-added ((t (:foreground "#73c936" :background unspecified))))
 ...
 '(ido-first-match ((t (:foreground "#ffdd33" :bold unspecified))))
 ...
 '(highlight ((t (:background "#282828" :foreground unspecified))))
 '(highlight-current-line-face ((t (:background "#282828" :foreground unspecified))))
 ...
 '(tab-bar-tab ((t (:background unspecified :foreground "#ffdd33" :weight bold))))
